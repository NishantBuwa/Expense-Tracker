...
function Piechart({ expenseData }) {
    ...
    return (
        <div className="grid grid-cols-2 gap-6 md:text-[15px] text-[8px] ">
            ...
            <div className=''>
                <h2 className='text-center  xl:text-[35px] lg:text-[30px] md:text-[25px] sm:text-[20px] text-[16px] text-yellow-500 text-lg sm:font-semibold'>Expenses by Category Type</h2>
            ...
            <div className=''>
                <h2 className='text-center xl:text-[35px] lg:text-[30px] md:text-[25px] sm:text-[20px] text-[16px] text-yellow-500 text-lg sm:font-semibold'>Expenses by Payment Type</h2>
                <ResponsiveContainer width="100%" height={chartSize.height}>
                    <PieChart>
                        <Pie
                            data={ptypeData}
